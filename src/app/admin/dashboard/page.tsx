...
export default function DashboardOverviewPage() {
  ...
  // Let layout.tsx handle the redirect if session is empty
  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      {/* QUICK STATS CARDS */}
      {/* THE FIX: Changed to "grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" to force horizontal layout on desktop */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <div className="bg-stone-900 border border-stone-800 p-6 rounded-2xl shadow-sm relative overflow-hidden flex flex-col justify-center">
          ...
          <p className="text-4xl font-oswald text-stone-100 relative z-10">6</p>
        </div>
        ...
        <div className="bg-stone-900 border border-stone-800 p-6 rounded-2xl shadow-sm relative overflow-hidden flex flex-col justify-center">
          ...
          <p className="text-4xl font-oswald text-amber-500 relative z-10">1</p>
        </div>
        ...
        <div className="bg-stone-900 border border-stone-800 p-6 rounded-2xl shadow-sm relative overflow-hidden flex flex-col justify-center">
          ...
          <p className="text-4xl font-oswald text-red-500 relative z-10">2</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {session.role === 'manager' && (
          <>
            <Link href="/admin/pricing" className="group bg-stone-900 hover:bg-stone-800 border border-stone-800 hover:border-amber-900/50 p-6 rounded-xl transition-all">
            ...
            <Link href="/admin/finance" className="group bg-stone-900 hover:bg-stone-800 border border-stone-800 hover:border-amber-900/50 p-6 rounded-xl transition-all">
