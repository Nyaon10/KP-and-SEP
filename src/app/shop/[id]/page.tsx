...
const PRODUCTS = [
  { 
    ...
    origin: "Indonesia, Kerinci", 
    tastingNotes: ["Floral", "Honey", "Red Apple"],
    description: "A romantic blend featuring the unique fermentation of Kerinci beans. Expect a high floral aroma with a sweet honey finish.",
    reviews: [
      { id: 1, user: "Budi S.", rating: 5, comment: "The floral notes are very prominent. Best Kerinci I've had.", date: "2024-02-10" },
      { id: 2, user: "Siti R.", rating: 4, comment: "Very sweet, perfect for my V60 morning routine.", date: "2024-02-12" }
    ]
  },
  { 
    id: 'b2', 
    name: "My Sweet Miracle", 
    roast: "Kerinci Natural Anaerob", 
    acidityLevel: 3,
    roastLevel: 2,
    price: 225000, 
    categorySlug: "exotic-arabica-blends-series", 
    image: "/images/SAB02-1.jpeg", 
    gallery: ["/images/SAB02-1.jpeg", "/images/SAB02-2.jpeg", "/images/SAB02-3.jpeg", "/images/SAB02-4.jpeg", "/images/SAB02-5.jpeg"],
    origin: "Indonesia, Kerinci", 
    tastingNotes: ["Sweet", "Berries", "Clean"],
    description: "A miracle in a cup. This blend emphasizes the berry-like acidity and cleanliness that only natural anaerob processing can provide.",
    reviews: []
  },
  { 
    id: 's1', 
    name: "When It's Love", 
    roast: "Karo Natural Anaerob", 
    acidityLevel: 5,
    roastLevel: 1,
    price: 235000, 
    categorySlug: "exotic-single-origin-series", 
    image: "/images/ESO01-1.jpeg", 
    gallery: ["/images/ESO01-1.jpeg", "/images/ESO01-2.jpeg", "/images/ESO01-3.jpeg", "/images/ESO01-4.jpeg", "/images/ESO01-5.jpeg"],
    origin: "Indonesia, Karo", 
    tastingNotes: ["Citrus", "Spices", "Earthy"],
    description: "Sourced from the highlands of Karo. This single origin is complex, offering a spicy kick balanced by bright citrus notes.",
    reviews: [
      { id: 1, user: "Andi H.", rating: 5, comment: "Complexity is 10/10. Karo beans never disappoint.", date: "2024-01-20" }
    ]
  },
  { 
    id: 's2', 
    ...
    price: 235000, 
    categorySlug: "exotic-single-origin-series", 
    image: "/images/ESO02-1.jpeg", 
    gallery: ["/images/ESO02-1.jpeg", "/images/ESO02-2.jpeg", "/images/ESO02-3.jpeg", "/images/ESO02-4.jpeg", "/images/ESO02-5.jpeg"],
    origin: "Indonesia, Kerinci", 
    tastingNotes: ["Blueberry", "Winey", "Chocolate"],
    description: "An intense sensory experience. Like walking through a field of berries, with deep chocolate undertones and a wine-like body.",
    reviews: []
  },
  { 
    id: 'c1', 
    name: "G'Day Mate", 
    roast: "Arabica Classic", 
    acidityLevel: 2,
    roastLevel: 2,
    price: 100000, 
    categorySlug: "commercial-bean-series", 
    image: "/images/CB01-1.jpeg", 
    gallery: ["/images/CB01-1.jpeg", "/images/CB01-2.jpeg", "/images/CB01-3.jpeg", "/images/CB01-4.jpeg", "/images/CB01-5.jpeg"],
    origin: "Multi-Origin Blend", 
    tastingNotes: ["Nutty", "Bold", "Caramel"],
    description: "The perfect daily driver. A classic Arabica profile that is bold enough for milk-based drinks but smooth enough for black coffee.",
    reviews: [
      { id: 1, user: "James T.", rating: 4, comment: "Solid daily coffee. Very reliable taste.", date: "2024-02-20" }
    ]
  },
  { 
    id: 'c2', 
    name: "Here Comes The Vibes", 
    roast: "60 : 40 Houseblend", 
    acidityLevel: 1,
    roastLevel: 3,
    price: 90000, 
    categorySlug: "commercial-bean-series", 
    image: "/images/CB02-1.jpeg", 
    gallery: ["/images/CB02-1.jpeg", "/images/CB02-2.jpeg", "/images/CB02-3.jpeg", "/images/CB02-4.jpeg", "/images/CB02-5.jpeg"],
    origin: "Wanst Signature Blend", 
    tastingNotes: ["Strong", "Bitter-Sweet", "Dark Chocolate"],
    description: "Our high-energy house blend. The 60:40 ratio provides the caffeine kick you need with a pleasant dark chocolate sweetness.",
    reviews: []
  }
];
...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    ...
    const savedFavorite = localStorage.getItem(`wanst-favorite-${productId}`);
  ...
  useEffect(() => {
    localStorage.setItem(`wanst-favorite-${productId}`, JSON.stringify(isFavorite));
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 mb-20">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-5 gap-3">
              {(product.gallery || [product.image]).map((img, index) => (
                <button key={index} onClick={() => setActiveImage(img)} className={`relative aspect-square rounded-lg overflow-hidden border-2 transition-all ${activeImage === img ? 'border-amber-700 ring-2 ring-amber-700/20' : 'border-stone-200 hover:border-stone-400'}`}><Image src={img} alt={`${product.name} view ${index + 1}`} fill className="object-cover" /></button>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-stone-600 leading-relaxed mb-8 italic">Experience the distinct flavor of {product.roast} roast. Sourced directly from {product.origin}.</p>
            ...
            <div className="flex gap-4 mb-8">
              ...
              <button onClick={() => setIsFavorite(!isFavorite)} className={`p-4 rounded-lg border flex items-center justify-center transition-all duration-200 active:scale-[0.90] ${isFavorite ? 'bg-rose-50 border-rose-200 text-rose-500' : 'bg-white border-stone-300 text-stone-400 hover:text-rose-500 hover:border-rose-200 hover:bg-rose-50'}`} aria-label="Toggle Favorite" title={isFavorite ? "Remove from Favorites" : "Add to Favorites"}><HeartIcon filled={isFavorite} /></button>
            </div>
          </div>
        </div>
